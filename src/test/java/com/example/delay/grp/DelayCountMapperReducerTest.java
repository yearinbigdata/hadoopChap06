...
public class DelayCountMapperReducerTest {
	...
	public void testMapReduce1() throws IOException {
		...
		mapReduce.withKeyGroupingComparator(new DateKeyGroupComparator());
